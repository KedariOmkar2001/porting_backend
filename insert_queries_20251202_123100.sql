...
-- Generated on: 2025-12-02 12:31:00
-- ================================================================================
BEGIN;
...
INSERT INTO um.umsm_user (
    ...
    90, 
    '34679', 
    'gAAAAABpLo6sI6bslKxlQXpES-OfK_dosAZOU-hrtIaFOcyT3v3DODAbM4TPRb0WQ4fFRsXfDJT91Wv14t2nSO2L0d2KUx4x4J2UKH-ZjrYWvtrlO1TtI6M=', 
    'gAAAAABpLo6s99oedo4LBPMMjoY937GThidzpygcsZFh8Wm2o-VA7YeEJKIr4gUxpNG9sfH6tMqDaMCSBoKSXRJzKoxluebWdQ==', 
    'Welcome@2024',
    '',
    'A', 'N', 'N',
    '2023-04-03', NULL,
...
INSERT INTO um.umsm_user (
    ...
    91, 
    '11425', 
    'gAAAAABpLo6szVFM7JOUu4V7Pxp7X4Txz3-hVQh41FC9fJCe4Mo_PtDxz9R6vV0C1Aa1up0srVy6rDSFjeSHoyW4nvLVyW_a4qzB-DtWbRq4Ie2_su8wZFg=', 
    'gAAAAABpLo6sxDoS_YOOf58sywTNpes9drDrkfekqJ2WW3HRD-zNLWZTqrLGZi0kVfVAySMlc4lgm7FHHhQYsqIh2Q34PpoDEQ==', 
    'Welcome@2024',
    '',
    'A', 'N', 'N',
    '2023-08-05', NULL,
...
INSERT INTO um.umsm_user (
    ...
    92, 
    '45354', 
    'gAAAAABpLo6svH8m3abJRXdIwh5qrtOe1R1XHeWTfQOje-YHRIKVD4gbrCHTjXHdnjdUjJwNc0aGp5WJfeXRMElerdUmrZMPqz5P9A-Ij79HCSbMNZddikw=', 
    'gAAAAABpLo6sY7DWQaYiOtEMGDQDSTpGA0THWM9_AFlmdxJVI-TpMB4sO--JAsJSrDoshHECCEB_WnUHN016psUECEC4mVCGyQ==', 
    'Welcome@2024',
    '',
    'A', 'N', 'N',
    '2025-10-18', NULL,
...
INSERT INTO um.umsm_user (
    ...
    93, 
    '31331', 
    'gAAAAABpLo6sEWL9Hx4Ip4K8o7cYlKKnnkaSMuDU0CwBeO5qiLbol8gihYa3cMjrJ3HOeD9-xcfykrxEzAK3q7d9FW8Ky1u9e_sMuoX-2SSkQ0t30tsq4JU=', 
    'gAAAAABpLo6scEK35n11zbr3pypeCo5lGny339nK7pTvS_OP5U4duLGK9FihqHx76Rj-2mm2a3itMzhuIjh84UJpGSAO5UxY2w==', 
    'Welcome@2024',
    '',
    'A', 'N', 'N',
    '2023-08-01', NULL,
...
INSERT INTO um.umsm_user (
    ...
    94, 
    '12697', 
    'gAAAAABpLo6sOa-wmEAWhc3GYvHech8KGOLJxZfXeOEbVN_AQN2jw_sewURxWwpXBqkE2Y8qbSC-x8cL0412N9T4Qc7uZZzTLl_KH_BLRE1s6YMDv8XBTPg=', 
    'gAAAAABpLo6sesLyGvugckgvcFt6CoOwMbyHpoPnncHFekfkr_YqCwi9GJcy9VaUB9JPRzNPfsSAr6_pmNvsP5IJMwcHahGBkw==', 
    'Welcome@2024',
    '',
    'A', 'N', 'N',
    '2024-03-16', NULL,
